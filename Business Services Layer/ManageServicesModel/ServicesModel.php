...
class ManageServicesModel{
    public $device_id, $device_type, $device_model, $serialNo, $device_os, $damage_type, $damage_desc, $request_status, $estimate_price, $quotation_status;
    
    //add device & damange info
    function addDevice(){
        $sql = "insert into device(device_type, device_model, serialNo, device_os, damage_type, damage_desc, customer_id, request_status, estimate_price, quotation_status) values(:device_type, :device_model, :serialNo, :device_os, :damage_type, :damage_desc, :customer_id, :request_status, :estimate_price, :quotation_status)";
       

        $args = [':device_type'=>$this->device_type, ':device_model'=>$this->device_model, ':serialNo'=>$this->serialNo, ':device_os'=>$this->device_os, ':damage_type'=>$this->damage_type, ':damage_desc'=>$this->damage_desc, 'customer_id'=>$this->customer_id, ':request_status'=>$this->request_status, ':estimate_price'=>$this->estimate_price, ':quotation_status'=>$this->quotation_status];
