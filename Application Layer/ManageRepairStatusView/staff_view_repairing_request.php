...
$data = $request->viewRepairingRequest();
...
<html>
	<head>
		<title>DERCS | REPAIRING REQUESTS</title>
		<meta charset="utf-8" />
                                    ...
                                    <div class="table-wrapper">
                                                    ...
                                                    . "<td>".$row['job_performed']."</td>"
                       								...
                       								. "<td>".$row['repair_status']."</td>";
               											?>
               										<td><input type="button" onclick="location.href='staff_edit_request_status.php?repair_device_id=<?=$row['repair_device_id']?>'" value="EDIT STATUS" class="primary">&nbsp
													</td>
               									</tbody>
               									<?php
               									$i++;
